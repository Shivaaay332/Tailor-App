  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-10 px-6">
      <div className="sm:mx-auto sm:w-full sm:max-w-md bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
        ...
        <h2 className="text-center text-2xl font-extrabold text-gray-900 mb-2">Naya Khata Banayein</h2>
        <p className="text-center text-sm text-gray-500 mb-8">Apni Tailor Shop ka setup karein</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-1">Aapka Naam</label>
            <input 
              type="text" required
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-1">Dukan (Shop) ka Naam</label>
            <input 
              type="text" required
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-primary text-white py-4 rounded-xl font-bold shadow-lg shadow-primary/30 active:scale-[0.98] transition-all disabled:opacity-70 mt-4"
          >
        ...
        <p className="mt-6 text-center text-sm text-gray-600 font-medium">
          ...
          <Link to="/login" className="font-bold text-primary hover:text-indigo-500">
            Yahan Login karein
          </Link>
        </p>
      </div>
