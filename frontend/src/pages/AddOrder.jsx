...
const AddOrder = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate('/dashboard'); // Order banne ke baad dashboard par bhejo
    },
    onError: (error) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-primary px-4 pt-6 pb-6 rounded-b-[2rem] shadow-sm relative text-center">
        <Link to="/dashboard" className="absolute left-4 top-6 text-white p-1 bg-white/20 rounded-full active:bg-white/30">
          <ArrowLeft size={20} />
        </Link>
      ...
      <div className="px-4 mt-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
            ...
            {isLoading ? (
              <p className="text-sm text-gray-400">Grahak load ho rahe hain...</p>
            ) : (
              <select 
                name="customerId" 
                required
                ...
                className="w-full p-3 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-primary text-sm font-semibold text-gray-800 border-none"
              >
            ...
            {!formData.customerId && customers.length > 0 && (
               <p className="text-[10px] text-orange-500 mt-2 font-medium">Agar grahak naya hai, toh pehle 'Customers' tab se use add karein.</p>
            )}
          </div>
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div>
                <span className="text-[10px] text-gray-400 font-bold ml-1">KAPDA (ITEM)</span>
                <select 
                  name="garmentType" 
                  value={formData.garmentType} 
                  onChange={handleChange}
                  className="w-full p-3 mt-1 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-primary text-sm font-semibold border-none"
                >
              ...
              <div>
                <span className="text-[10px] text-gray-400 font-bold ml-1">KITNE PIECE?</span>
                <input 
                  type="number" 
                  name="quantity" 
                  min="1"
            ...
            <div className="relative mt-2">
              <span className="text-[10px] text-gray-400 font-bold ml-1">SILAI KA RATE (PER PIECE) *</span>
              <div className="relative mt-1">
                ...
                <input 
                  ...
                  onChange={handleChange}
                  className="w-full pl-9 pr-3 py-3 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-primary text-sm font-semibold border-none" 
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div>
                <span className="text-[10px] text-gray-400 font-bold ml-1">ADVANCE DIYA (₹)</span>
                <input 
                  type="number" 
                  name="advanceAmount" 
                  placeholder="0"
              ...
              <div>
                <span className="text-[10px] text-gray-400 font-bold ml-1">DELIVERY DATE *</span>
                <input 
                  type="date" 
                  name="dueDate" 
                  required
            ...
            <div className="relative">
              <span className="text-[10px] text-gray-400 font-bold ml-1">KUCH KHAS NOTES (OPTIONAL)</span>
              <div className="relative mt-1">
                ...
                <input 
                  ...
                  onChange={handleChange}
                  className="w-full pl-9 pr-3 py-3 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-primary text-sm border-none" 
                />
              </div>
            </div>
          </div>
          ...
          <button 
            ...
            className="w-full bg-primary text-white font-bold py-4 rounded-xl shadow-lg active:scale-95 transition-all mt-2"
          >
